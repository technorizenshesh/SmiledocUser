...
public class AdapterFilterDoctor extends RecyclerView.Adapter<AdapterFilterDoctor.ViewHolder> {
    Context context;
    ArrayList<DoctoreListModal> arrayList;

    public AdapterFilterDoctor(Context context, ArrayList<DoctoreListModal> arrayList) {
